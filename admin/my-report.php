...
// Function to get sales report for the current admin
function getSalesReport($conn, $staffId, $startDate = null, $endDate = null) {
    // Query adjusted to use the admins table for reporting
    $query = "SELECT oi.*, o.order_date as sale_date, a.name as admin_name, p.name as product_name 
              FROM order_items oi
              INNER JOIN orders o ON oi.order_id = o.id
              INNER JOIN admins a ON o.order_placed_by_id = a.id
...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    // Fetch the sales report for the current admin
    $salesReport = getSalesReport($conn, $currentStaffId, $startDate, $endDate);
...
<div class="container-fluid px-4">
    <div class="card mt-4 shadow-sm">
        <div class="card-header">
            <h4 class="mb-0">Generate My Sales Report
