...
if(isset($_POST['saveAdmin']))
{
    ...
    if($name !='' && $email != '' && $password !=''){
        ...
        $emailCheck = mysqli_query($conn, "SELECT * FROM admins WHERE email='$email'");  //check already existing emails.
        if($emailCheck){
...
//Update after edit/ fetch data to update record
if(isset($_POST['updateAdmin']))
{
    ...
    //check in a condition, if you don't enter a password, it update a blank value
    if($password != ''){
...
if(isset($_POST['saveCustomer']))
{
    ...
    if($name != '') //check if email exists or not
    {
