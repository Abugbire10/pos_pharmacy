...
<!-- adding a customer when no available Modal -->
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title fs-5" id="exampleModalLabel">Add Customer</h5>
...
<div class="container-fluid px-4">
    <div class="card mt-4 shadow-sm">
        <div class="card-header">
         <h4 class="mb-0">Purchase a Product 
            ...
            if(isset($_SESSION['productItems']))
            {
                ...
                <div class="mt-2">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4">
                            <br>
                            <button type="button" class="btn btn-warning w-100 proceedToPlace">PROCEED MAKE PAYMENT</button>
                        </div>
                    </div>
                </div>
